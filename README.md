...
The initial implementation intentionally keeps room state in memory. SQLite persistence, reconnect tokens, complete modifier mechanics, session analytics, and optional Qwen commentary come next.
